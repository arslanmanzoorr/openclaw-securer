...
export async function installDownloadSpec(params: {
  ...
  // ClawHub supply-chain attack mitigation: block all remote skill downloads.
  // Over 800 malicious skills were found in the ClawHub registry (ClawHavoc campaign).
  // Remote skill installation is disabled until the registry has adequate security controls.
  return {
    ok: false,
    message:
      "Remote skill downloads are disabled for security. " +
      "The ClawHub registry has been compromised with malicious skills. " +
      "Install skills manually from trusted sources only.",
    stdout: "",
    stderr: "",
    code: null,
  };
